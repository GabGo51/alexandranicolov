...
const Serie4 = () => {
  return (
    <Container>
      <img alt="serie1" src={s4_1} />
      <img alt="serie1" src={s4_2} />
      <img alt="serie1" src={s4_3} />
      <img alt="serie1" src={s4_4} />
      <img alt="serie1" src={s4_5} />
      <img alt="serie1" src={s4_6} />
      <img alt="serie1" src={s4_7} />
      <img alt="serie1" src={s4_8} />
      <img alt="serie1" src={s4_9} />
      <img alt="serie1" src={s4_10} />
      <img alt="serie1" src={s4_11} />
      <img alt="serie1" src={s4_12} />
      <img alt="serie1" src={s4_13} />
      <img alt="serie1" src={s4_14} />
      <img alt="serie1" src={s4_15} />
      <img alt="serie1" src={s4_16} />
      <img alt="serie1" src={s4_17} />
    </Container>
  )
}
