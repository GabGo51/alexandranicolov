    ...
    <Container>
      <div className="layer">
        <div className="first colum">
          <img onClick={() => openOverlay(s1_1)} alt="serie1" src={s1_1} />
          <img onClick={() => openOverlay(s1_3)} alt="serie1" src={s1_3} />
          <img onClick={() => openOverlay(s1_5)} alt="serie1" src={s1_5} />
        </div>
        <div className=" second colum">
          <img onClick={() => openOverlay(s1_2)} alt="serie1" src={s1_2} />
          <img onClick={() => openOverlay(s1_4)} alt="serie1" src={s1_4} />
      ...
      <div className="layer">
        ...
        <div className="fourth column">
          <img onClick={() => openOverlay(s1_8)} alt="serie1" src={s1_8} />
        </div>
      </div>
      ...
      <div className="layer">
        <div className="fifth column">
          <img onClick={() => openOverlay(s1_12)} alt="serie1" src={s1_12} />
